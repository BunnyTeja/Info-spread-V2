...
;        set track-list lput initial-track-list track-list
       [ set sub-list [(list agent-type agent-id stance? received-IP-list sent-IP-list topic-id )] of t
     set track-list lput sub-list track-list
        ]
    ]
  ]
...
to writeIPs-to-file
  ...
  if i = 0[
    ...
    set initial-track-list2 ["agent-type" "agent-id" "stance?" "topic"]
   ...
   foreach sort turtles [ t ->
    ask t [if agent-type = "IPs"[
        set sub-list2 [ (list agent-type agent-id stance? related-topic-id)] of t
...
to writetopics-to-file
  ...
  if i = 0[
    ...
    set initial-track-list3 ["agent-type" "agent-id" "stance?" "topic-id"]
...
;        set track-list lput initial-track-list track-list
       [ set sub-list3 [(list agent-type agent-id stance? topic-id shape )] of t
     set track-list3 lput sub-list3 track-list3
        ]
    ]
  ]
...
to writegroupss-to-file
  ...
  if i = 0[
    ...
    set initial-track-list4 ["agent-type" "agent-id" "stance?" "group-id"]
   ...
   foreach sort turtles [ t ->
    ask t [if agent-type = "groups"[
        set sub-list4 [ (list agent-type agent-id stance? group-id)] of t
